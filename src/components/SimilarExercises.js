...
const SimilarExercises = ({ targetMuscleExercises, equipmentExercises }) => (
	<Box sx={{ mt: { lg: "100px", xs: "0px" } }}>
		<Typography sx={{ fontSize: { lg: "44px", xs: "25px" }, ml: "20px" }} fontWeight={600} color="#000" mb="33px">
			Similar <span style={{ color: "#fbbf24", textTransform: "capitalize" }}>Target Muscle</span> exercises
		</Typography>
		...
		<Typography sx={{ fontSize: { lg: "44px", xs: "25px" }, ml: "20px", mt: { lg: "100px", xs: "60px" } }} fontWeight={600} color="#000" mb="33px">
			Similar <span style={{ color: "#fbbf24", textTransform: "capitalize" }}>Equipment</span> exercises
		</Typography>
		<Stack direction="row" sx={{ p: 2, position: "relative" }}>
